        ...
        >
            <div className='md:flex justify-between items-center h-[280px] mt-20'>
                <div className='md:w-[57%]  w-full headlight flex justify-center items-center flex-col text-white'>
                    <h1 className='lg:text-5xl xl:text-6xl md:ml-[-40px] ml-[-44px] md:text-4xl text-2xl w-[80%] font font-bold md:leading-[68px] text-white z-10'>Take the Headlight 40% off</h1>
                    <p className='w-[70%] md:ml-[-89px] ml-[-77px] mt-2 text-xl p-0 text-white' >This discount is not valid in conjunction with other offers</p>
                </div>
