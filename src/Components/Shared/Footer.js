    ...
    return (
        <footer >
            <div className="footer p-10  bg-black text-white justify-items-start">
                ...
                <div>
                    <span className="footer-title text-xl text-white opacity-100">Services</span>
                    <Link to='/' className="link link-hover">Engine</Link>
                    <Link to='/' className="link link-hover">Headlight</Link>
                    <Link to='/' className="link link-hover">Fuel Tank</Link>
                    <Link to='/' className="link link-hover">Advertisement</Link>
                </div>

                <div>
                    <span className="footer-title text-xl text-white opacity-100">Legal</span>
                    <Link to='/' className="link link-hover">Terms of use</Link>
                    <Link to='/' className="link link-hover">Privacy policy</Link>
                    <Link to='/' className="link link-hover">Cookie policy</Link>
                </div>
                <div className='w-[310px] md:w-full ml-[-27px] md:ml-0'>
                    <span className="footer-title text-xl  text-white opacity-100">Newsletter</span>
                    <div className="form-control   ">
                        <label className="label">
                            <span className="label-text text-white ">Enter your email address</span>
                        </label>
                        <div className="relative w-[310px] md:w-full">
            ...
            <div className="footer items-center p-4 bg-[#333] text-white">
